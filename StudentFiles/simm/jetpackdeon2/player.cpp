...
static const float maximum_acceleration = 200.0f; //units per second per second
static const float maximum_speed = 100.0f; //units per second
...
public:
     ...
     void apply_control(control action, keystate state) {
          ...
          case release:
               switch (action) {
               case thrust:
                    acceleration = 50.0f;// moves object forward was 0
                    break;
               case left:
                    angular_velocity = 0.0f;
                    break;
...
void control_super(control action, keystate state)
{
