...
void set_start(ball_instance & instance)
{
	...
	instance.position[1] = 50.0f;
	instance.velocity[0] = -150.0f;
...
{
	instance.position[2] += instance.velocity[1] * time;
	...
	instance.velocity[1] -= 9810.0f * time; 
}
...
int main(int argc, char * argv[])
{
	...
	ball_definition definition = { "sleep.bmp", "bounce.bmp", 50.0f };
	ball_type type;
