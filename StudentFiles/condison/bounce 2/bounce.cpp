...
{
	instance.position[0] = -210.0f;
	instance.position[1] = 10.0f;
	instance.velocity[0] = 30.0f;
	instance.velocity[1] = 20.0f;
}

const int screen_height = 680;
const GLfloat base = GLfloat(-screen_height / 1);
...
{
	instance.position[1] += instance.velocity[0] * time;
...
int main(int argc, char * argv[])
{
	...
	ball_definition definition = { "cold.bmp", "bounce.wav", 50.0f };
	ball_type type;
