...
start_game:
	...
	_cputs(
		"\n"
		"Welcome to the jungle, I will let you know how to play in the forest.\n"
		"choose what to do."
		"\n"
...
follow_stream:
    _cputs(
        "\n"
        "follow the course of the stream through the forest until you reach a point\n"
...
return_key:
	_cputs(
		"\n"
		"return the small key to its hook.\n"
		"\n");
	have_key = false;
	goto describe_hut;
...
take_key:
	_cputs(
		"\n"
		"Take the small key and leave the hut.\n"
		"\n");
	have_key = true;
	goto describe_forest;
