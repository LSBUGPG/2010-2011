...
go_underground: //go_underground sequence is used a quick death route for testing the build
	_cputs(
		"\n"
...
describe_piano:
	...
	if (musicbox_locked && have_paper) { //Original sequence would include a sound file to be played at this point if [p] is selected
		_cputs(
...
the_end:
	_cputs(
		...
		"\n"
		"* * * * * * * * * * * * * * * * * * * * * * * * * *\n"
		"Thank you for playing MIND,\n"
		"\n"
		"This game was created, designed and built by,\n"
		"Matthew W Davie,\n"
		"Testing was done by,\n"
		"London South Bank - Game Cultures Students,\n"
		"Games-Workshop Maidstone\n"
		"* * * * * * * * * * * * * * * * * * * * * * * * * *\n"
		"\n");
