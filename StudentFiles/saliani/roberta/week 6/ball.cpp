...
static const GLfloat base = GLfloat(-screen_height / 1.95); //lower y axis previous value 2 as the float base is 246f is wrong(?), should be value 240, this is an easy way out
static const GLfloat width = GLfloat(-screen_width / 2); 
static const int number_of_balls = 10; //orderly previous value 10
...
public:
     ...
     void update(float time) {
          ...
          velocity[1] -= GLfloat(2000.0f * time); 
     }
