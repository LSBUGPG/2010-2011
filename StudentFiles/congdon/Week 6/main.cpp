...
public:
	object_types_array()                                                //types array. one area for balls, one for motes. Function called a constructer, writes an array, shares same name
	{
		static object * object_types[] = {                            //array in a array
			load_ball_objects("ball.bmp", "bounce.wav", 40.0f),
			load_mote_objects("ball.bmp", 5.0f),  //THIS IS WHERE NEW OBJECTS ARE MADE
			load_footy_objects("footy.bmp", 17.0f),
		};
