...
/*
Mod of Adventure.cpp ver1.0
Ali Yeter
LSBU Game Cultures YR2 - Programming
Week 3 excerise 
aliyeter@gmail.com
*/

#include <conio.h> //include the conio header files
#include <Windows.h> //include the windows header files

using namespace std; //to group a set of global classes


int main(int argc, char *argv[]) //declaring variables
{
	_cputs("Loading..."); //loading text
		Beep(5000,1000); //To add sound, first entry is for pitch, and second is duration.
		Beep(500,500);
		Beep(5000,1000);
		Beep(5000,1000);
		Beep(500,500);
		Beep(5000,1000);
		Sleep(1000); //To end sound
		void clear();
	int answer; //interger variables
	bool have_key;
	bool grate_locked;  //booleen variables
...
start_game:
	...
	_cputs(		
		"\n"
		"Welcome to the Super Fun Land! Just follow the game and\n"
		"choose what to do."
		"\n"
		...
		"\n"
		"\n...............................................................................\n");
		//cputs is the basic function to display text on a cmd interface
describe_forest:
	_cputs(
		"You are in a mystical forest. Beside you is a small stream. The forest is\n"
		"unexpectedly quiet. The only sound is the gentle trickle of the water. There is\n"
		"also a small cave nearby. The door appears unlocked.\n"
		"\n"
		"Will you:\n"
		"[e] enter the cave; or,\n"
		"[f] follow the stream?\n"
...
take_key:
	_cputs(
		"\n"
		"You take the small key and leave the cave.\n"
		"\n");
	have_key = true;
	goto describe_forest;
...
describe_cave:
	_cputs(
		...
		"shape of a Wild Horse. The Wild Horse bares its teeth and prepares to strike.\n"
		"\n"
		"Will you:\n"
		"[f] fight the Wild Horse; or,\n"
...
last_chance:
	_cputs(
		...
		"[f] fight the Horse barehanded; or,\n"
...
kill_dragon:
	_cputs(
		"\n"
		"Incredibly, you fight and kill the Horse with your bare hands! You wake, with\n"
...
survivor:
	_cputs(
		"Your adventure is at an end. You have faced a Horse and yet live to tell the\n"
